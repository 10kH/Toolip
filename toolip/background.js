...
if (chrome.contextMenus && !actionMenu) {
  ...
  const shareOptions = [
    {
      id: 'share-email',
      title: 'Email',
      url: 'mailto:?subject=Check out Toolip&body=',
    },
    {
      id: 'share-x',
      title: 'X (Twitter)',
  ...
  chrome.contextMenus.onClicked.addListener((info, tab) => {
    const extensionPage =
      'https://chrome.google.com/webstore/detail/toolip-prototype'; // TODO: change to the actual extension page
    const shareMessage = encodeURIComponent(
      'Check out Toolip Extension: ' + extensionPage
    );
